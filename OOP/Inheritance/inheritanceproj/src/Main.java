...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Part-time paycheck: " + partTimeEmployee.calculatePayheck());
        System.out.println("Full-time paycheck: " + fullTimeEmployee.calculatePayheck());
        System.out.println("Contractor paycheck: " + contractorEmployee.calculatePayheck());
    }
}